    ...
    return {
        ...
        load: function(name, parentRequire, load, _config) {
            ...
            function getExternalDeps(nodes) {
                ...
                var defaultHelpers = ['helperMissing', 'blockHelperMissing', 'each', 'if', 'unless', 'with', 'log', 'lookup'];
                return {
            ...
            function fetchAndRegister(langMap) {
                fetchText(path, function(text, path) {
                    ...
                    helpDepStr = disableHelpers ? '' : (function() {
                        var i;
                        var paths = [];
                    ...
                    if (config.hbs._partials[name]) partialReferences = config.hbs._partials[name].references;
